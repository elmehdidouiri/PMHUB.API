...
namespace PMHUB.API.Controllers
{
    ...
    public class HourEntriesController : ControllerBase
    {
        ...
        public HourEntriesController(IHourEntryService hourEntryService, ILogger<HourEntriesController> logger, IHourSummaryService hourSummaryService)
        {
        ...
        public async Task<IActionResult> GetMyEntries()
        {
            ...
            return Ok(ApiResponse<IEnumerable<HourEntrySummaryDto>>.Ok(result));
        }
        ...
        public async Task<IActionResult> GetPendingPremium()
        {
            ...
            return Ok(ApiResponse<IEnumerable<HourEntryDto>>.Ok(result));
        }
        ...
        [HttpGet("summary/projects")]
        public async Task<IActionResult> GetProjectSummary([FromQuery] int year)
        {
        ...
        public async Task<IActionResult> GetUserSummary([FromQuery] int year)
        {
            var result = await _hourSummaryService.GetUserSummary(year);
            return Ok(ApiResponse<IEnumerable<UserHoursDto>>.Ok(result));
        }

        [HttpGet("summary/top-projects")]
        public async Task<IActionResult> GetTopProjects([FromQuery] int year, [FromQuery] int top = 5)
        {
            var result = await _hourSummaryService.GetTopProjects(year, top);
            return Ok(ApiResponse<IEnumerable<ProjectHoursDto>>.Ok(result));
        }
    }
}